...
';
		$this->renderBlock('plugincss', get_defined_vars()) /* line 14 */;
    ...
    <script>
        ...
        const BASEURL = ';
		echo LR\Filters::escapeJs(\AbieSoft\Utilities\Config::envReader('BASEURL')) /* line 27 */;
		echo ';
        const APIKEY = ';
		echo LR\Filters::escapeJs(\AbieSoft\Utilities\Config::envReader('APIKEY')) /* line 28 */;
		echo ';
    </script>
';
		$header = false /* line 30 */;
		echo '</head>
<title>';
		$this->renderBlock('title', get_defined_vars()) /* line 32 */;
		echo '</title>
<body class="';
		...
		echo '">
';
		$this->createTemplate('theme/components/header.php.latte', $this->params, 'include')->renderToContentType('html') /* line 34 */;
		$this->renderBlock('content', get_defined_vars()) /* line 35 */;
		$this->renderBlock('dialog', get_defined_vars()) /* line 36 */;
		$this->createTemplate('theme/components/footer.php.latte', $this->params, 'include')->renderToContentType('html') /* line 37 */;
		echo '
    <script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl(\AbieSoft\Utilities\Config::envReader('BASEURL'))) /* line 39 */;
...
';
	...
	/** {block plugincss} on line 14 */
	public function blockPlugincss(array $ʟ_args): void
	{
	}


	/** {block title} on line 32 */
	public function blockTitle(array $ʟ_args): void
	{
	}


	/** {block body} on line 33 */
