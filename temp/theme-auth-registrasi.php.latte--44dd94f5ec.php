...
final class Template44dd94f5ec extends Latte\Runtime\Template
{
	public const Blocks = [
		...
		echo '/assets/media/images/logo_google.png" class="w-[25px] h-[25px] mr-[10px]">
                        ...
                        <div class="px-4">
                            <div class="mb-2">
                                ...
                                <input id="nama" name="nama" class="focus:border-sky-600 radius-lg px-4 py-2 border border-gray-200 w-full outline-none" placeholder="Nama" autocomplete="off">
                            </div>
                            <div class="mb-2">
