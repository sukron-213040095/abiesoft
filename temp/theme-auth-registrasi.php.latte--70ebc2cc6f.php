...
';
		...
		echo "\n";
		$this->renderBlock('pluginjs', get_defined_vars()) /* line 86 */;
		$this->renderBlock('pagejs', get_defined_vars()) /* line 87 */;
	}
...
';
		...
		echo '
                            <div class="px-4 ';
		if ($googleAkun == 'Ada') /* line 48 */ {
			echo 'mt-4';
		}
		echo '">
                                ';
		echo LR\Filters::escapeHtmlText($blokemail) /* line 49 */;
		echo '
                                <div class="mb-2">
		...
		echo '">
                                ...
                                <div class="mb-2">
';
		if ($googleAkun == 'Tidak Ada') /* line 55 */ {
			echo '                                    <label class="text-[10pt]" for="email">Email</label>
';
		}
		echo '                                    <input type=\'';
		echo LR\Filters::escapeHtmlAttr($type) /* line 58 */;
		echo '\' id="email" name="email" class="focus:border-sky-600 radius-lg px-4 py-2 border border-gray-200 w-full outline-none" placeholder="Email" value="';
		...
		echo '">
                                ...
                                <div class="mb-4">
                                    ';
		echo LR\Filters::escapeHtmlText(\AbieSoft\Utilities\Generate::token()) /* line 69 */;
		echo '<input type="hidden" id="__token" name="__token" value="';
		echo LR\Filters::escapeHtmlAttr(\AbieSoft\Magic\Reader::token()) /* line 69 */;
		echo '">
    ...
    <div class="text-center mt-[50px] mb-[25px] text-[11pt] font-semibold">&copy; ';
		echo LR\Filters::escapeHtmlText(date('Y')) /* line 83 */;
		echo ' | <span>Umieali Cake & Cookies</span></div>
';
	}


	/** {block pluginjs} on line 86 */
	public function blockPluginjs(array $ʟ_args): void
	{
	}


	/** {block pagejs} on line 87 */
