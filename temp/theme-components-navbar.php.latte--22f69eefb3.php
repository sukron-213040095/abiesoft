...
final class Template22f69eefb3 extends Latte\Runtime\Template
{
	public const Blocks = [
		['navbar' => 'blockNavbar'],
	];
	...
	{
		echo '    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse"
      role="navigation">
      <div class="navbar-header">
		...
		echo LR\Filters::escapeHtmlText(\AbieSoft\Utilities\Config::envReader('APP_TITLE')) /* line 19 */;
		echo '</span>
        </a>
      ...
      <div class="navbar-container container-fluid">
		...
		echo '/profile?uid=1" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profile</a>
                <a class="dropdown-item" href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl(\AbieSoft\Utilities\Config::envReader('BASEURL'))) /* line 62 */;
		echo '/seting" role="menuitem"><i class="icon wb-settings" aria-hidden="true"></i> Settings</a>
