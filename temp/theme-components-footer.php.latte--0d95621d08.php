...
final class Template0d95621d08 extends Latte\Runtime\Template
{
	public const Blocks = [
		['footer' => 'blockFooter'],
	];
	...
	{
		if (\AbieSoft\Utilities\GetUri::currentPage() != 'registrasi' && \AbieSoft\Utilities\GetUri::currentPage() != 'login' && \AbieSoft\Utilities\GetUri::currentPage() != 'login?next=http:') /* line 2 */ {
    ...
    <div class="float ml-auto mr-auto w-[1100px]">
        <div class="w-full mb-4">
			...
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl(\AbieSoft\Utilities\Config::envReader('BASEURL'))) /* line 49 */;
