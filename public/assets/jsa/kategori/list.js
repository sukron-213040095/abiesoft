...
kategori.onmessage = function(e) {
    ...
    for(let i=0; i < data.length; i++){
        result += `
        <a href="`+data[i].slug+`" class="bg-white cursor-pointer rounded-md overflow-hidden hover:shadow-lg border-solid border-[2px] border-white hover:border-solid hover:border-[2px] hover:border-sky-300">
