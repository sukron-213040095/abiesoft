...
// let doBackground = new Worker('worker.js');

// doBackground.postMessage(1,2);

// doBackground.onmessage = function(e) {
//     result.textContent = e.data;
//     console.log('Message received from worker');
// }


async function loadDataPalingLaku() {
    document.getElementById('dataPalingLaku').innerHTML = `
    ...
    `;
    await fetch(BASEURL + '/webservice/user?apikey='+ APIKEY +'&list=palinglaku')
...
async function loadDataDiskon() {
    document.getElementById('dataDiskon').innerHTML = `
    <div class="grid grid-cols-6 gap-4">
        <div class="bg-white rounded-md overflow-hidden border-solid border-[2px] border-white">
            <div class="w-full h-[180px] rounded-tl-md rounded-tr-md overflow-hidden">
                <div class="w-full h-[180px] bg-slate-100 shimmer"></div>
    ...
    `;
    await fetch(BASEURL + '/webservice/user?apikey='+ APIKEY +'&list=promo')
        .then(response => response.json())
        .then(data => {
            let result = "";
            result += `<div class="grid grid-cols-6 gap-4">`;
...
async function loadDataTerbaru() {
    document.getElementById('dataTerbaru').innerHTML = `
        <div class="grid grid-cols-6 gap-4">
            <div class="bg-white rounded-md overflow-hidden border-solid border-[2px] border-white">
                <div class="w-full h-[180px] rounded-tl-md rounded-tr-md overflow-hidden">
                    <div class="w-full h-[180px] bg-slate-100 shimmer"></div>
    ...
    `;
    await fetch(BASEURL + '/webservice/user?apikey='+ APIKEY +'&list=terbaru')
        .then(response => response.json())
        .then(data => {
            let result = "";
            result += `<div class="grid grid-cols-6 gap-4">`;
